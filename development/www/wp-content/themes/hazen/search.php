<?php get_header(); ?>
                    ...
                    <div id="inner_content_section">
                        ...
                        <?php get_template_part( 'magpro', 'slider' ); ?>                  
                  		<?php endif; ?>
											...
											<?php $count = 0; while (have_posts()) : the_post(); $count++; ?>
												...
												<div <?php post_class('actual_post') ?> id="post-<?php the_ID(); ?>">
													<div class="actual_post_title">
														<h2><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'Hazen' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
													</div>
