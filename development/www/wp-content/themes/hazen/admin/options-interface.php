...
function optionsframework_fields() {
	...
	foreach ( $options as $value ) {
		...
		case "adstwofifty":
						...
						$output .= '<div id="section-redit_id" class="section section-textarea"><div class="option">';
						...
						if( !of_get_option('magpro_sidebar_ads_twofifty') ) {
							...
							if($count>0)
							{
								...
								{									
									...
									$val = stripslashes( $val );
									$output .= '<div class="controls"><textarea id="magpro_sidebar_ads_twofifty_ad'.$i.'" class="of-input" name="' . esc_attr( $option_name . '[magpro_sidebar_ads_twofifty_ad' . $i . ']' ) . '" rows="10">' . esc_textarea( $val ) . '</textarea></div>';
							...
							{
								$output .= 'Go to Ad Settings tab and setup Number of banners.';
							}
